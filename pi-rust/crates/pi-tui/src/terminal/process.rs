...
//! [`crate::terminal::raw_tty`] queue into scrollback before the redraw scrubs it.

use std::io::{self, Stdout, Write};
use crate::terminal::raw_tty;
...
impl Terminal for ProcessTerminal {
    fn enter(&mut self) -> Result<(), TerminalError> {
        ...
        crate::terminal::raw_tty::set_raw_mode(true);
        Ok(())
    }
    ...
    fn suspend(&mut self) -> Result<(), TerminalError> {
        ...
        crate::terminal::raw_tty::flush_pending_to_stderr();
        crate::terminal::raw_tty::set_raw_mode(false);
