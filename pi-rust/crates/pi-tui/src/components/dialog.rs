...
use crate::core::input_parse::{Key, KeyCode};
        ...
        match &self.request {
            UiRequest::Confirm { title, body } => {
                ...
                lines.push(format!(
                    ...
                    dialog_hint(
                        &[
                            crate::components::keybindings::key_text_or("tui.select.confirm", "Enter"),
                            "y".to_string(),
                        ],
                        "accept",
                    ),
            ...
            UiRequest::Select { .. } => {
                ...
                lines.push(format!(
                    ...
                    dialog_hint(
                        &[
                            crate::components::keybindings::key_text_or("tui.select.up", "Up"),
                            crate::components::keybindings::key_text_or("tui.select.down", "Down"),
                        ],
                        "move",
                    ),
                    dialog_hint(
