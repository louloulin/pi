...
#[cfg(not(target_arch = "wasm32"))]
pub use render::{
    get_text_output, register_tool_renderer, render_diff, render_lines_ansi, render_lines_plain,
    renderer_for, unregister_tool_renderer, BashRenderer, EditRenderer, FindRenderer,
    GrepRenderer, InteractiveToolRenderer, LsRenderer, ReadRenderer, ToolRenderContext,
    ToolRenderOptions, ToolRendererRegistry, ToolRenderSession, ToolRenderer,
    WriteHighlightCache, WriteHighlightStats, WriteRenderer, BASH_PREVIEW_LINES, FIND_FOLD_LINES,
    GREP_FOLD_LINES, LS_FOLD_LINES, READ_FOLD_LINES, WRITE_FOLD_LINES,
